...
public class TempsByMonth {
    ...
    public String getCityTempInJun() {
        return cityTempInJun;
    }

    @ColumnInfo(name = "cityTempInJul")
    public String cityTempInJul;

    public String getCityTempInJul() {
        return cityTempInJul;
    }

    @ColumnInfo(name = "cityTempInAug")
    public String cityTempInAug;

    public String getCityTempInAug() {
        return cityTempInAug;
    }

    @ColumnInfo(name = "cityTempInSept")
    public String cityTempInSept;

    public String getCityTempInSept() {
        return cityTempInSept;
    }

    @ColumnInfo(name = "cityTempInOct")
    public String cityTempInOct;

    public String getCityTempInOct() {
        return cityTempInOct;
    }
